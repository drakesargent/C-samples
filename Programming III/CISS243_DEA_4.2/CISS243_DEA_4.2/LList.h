...
public:
	...
	T returnVal(int); // returns the value of the node in the linked list given the location value
	int numNodes(); // returns the total number of nodes in the linked list
	int getLen();
